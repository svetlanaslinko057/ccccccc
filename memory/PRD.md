...
### P0 - Content Updates ✅ COMPLETED
- [x] Адрес: проспект Миколи Бажана, 24/1, Київ, 02149
- [x] Доставка безкоштовна від 2000 грн
- [x] Видалити "Банківський переказ"
- [x] Сторінка "Обмін та повернення" - повний контент
